...
LDFLAGS := $(BOOST_LIB) $(OPENCV_LIB) $(GL_LIB) $(OPENMESH_LIB)
...
CONSOLE_APP_SRCS := ./main.cpp ./FileIO.cpp ./GLViewer.cpp 

CONSOLE_BIN := $(BIN_BUILD_DIR)/SequenceGen
